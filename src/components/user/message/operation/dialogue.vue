        ...
        <el-col :span="4" style="height: 100%;">
            <el-card style="height: 100%;" shadow="none">
                <el-col :span="24">
                    ...
                    >
                        <el-menu-item :index="index" v-for="(user,index) in data">
                            <el-avatar :size="40"
                                       src="https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png"/>
                            <span style="margin-left: 10px">{{ user.recipientsName }}</span>
                        </el-menu-item>
            ...
            <div style="height: 80%;display: block;overflow-y: scroll">
                <el-card>
                    ...
                    <el-row v-for="(item,index) in messageList" :key="index" style="margin-top: 20px">
                        <el-col :span="2">
                            <div v-if="item.recipientsId !== 0" style="position:relative;">
                        ...
                        <el-col :span="18">
                            <div style="display: inline-block;padding: 5px;border-radius: 20px"
                                 :style=" item.recipientsId !== 0 ? 'background:rgba(0,0,0,0.1);' : 'color: white;background:#337ecc;float:right'"
                            >
                                {{ item.message }}
                            </div>
                        </el-col>
        ...
        httpUtil.getData("online/getAllActiveOnLine").then(res =>{
            if(res.code==200){
                ...
                if (res.data.length>0){
                    this.data.messageList=res.data[0].cureentMessageList;
                }
            }
        })
    },
