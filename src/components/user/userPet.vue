                        ...
                        <table class="content-center">
                            ...
                            <tr v-if="pet.animalState ==='send'">
                                ...
                                <td>
                                    ...
                                    <div v-else-if="pet.animalHealthInfo!=null"
                            ...
                            <table>
                                ...
                                <tr>
                                    <td v-if="pet.animalState ==='send'">
                                        <p class="opera-button" v-if="isAdopt===false && pet.modifier != userId"
                                           @click="addAdopt">
                                            <el-icon>
                                                <House/>
                                            </el-icon>
                                    ...
                                    <td v-if="pet.animalState ==='search'">
                                        <p class="opera-button" v-if="pet.state !=3 " @click="searchFor(pet)">
                                            <el-icon>
                                                <House/>
                                            </el-icon>
                                            寻得宠物
                                        </p>
                                        <p class="opera-button" v-if="pet.state ==3">
                                            <el-icon>
                                                <HomeFilled/>
                                            </el-icon>
                                            已被寻得
...
export default {
    ...
    methods: {
        searchFor: function (pet) {
            let url = 'animalInfo/searchFor/' + pet.id;
